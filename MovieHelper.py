...
class Movie:
    def __init__(self, movie_name, url, has_ticket, movie_id, movie_length=None, genre=None, release_date=None, language=None, showing=False, is3d=None, sold_out=None, reservable=None):
        ...
        self.description = f"3D - {is3d}, Reservable - {reservable}, Sold Out - {sold_out}" if showing else f"{movie_length} mins | Tickets Available" if self.has_ticket else f"{genre} | {movie_length} | {release_date} Tickets Available Soon"
...
def get_coming_soon_movies():
    try:
        ...
        movies = [Movie(movie_name=movie['name'], has_ticket=movie['hasBuyTicket'],
                        ...
                        genre=movie['genre'],
                        release_date=movie['dtLocalRelease'],
